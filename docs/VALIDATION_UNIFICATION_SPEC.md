...
export const imageUrlSchema = z
  ...
  .refine(
    (url) =>
      !url.startsWith('data:image/') ||
      /^data:image\/(png|jpeg|jpg|webp|gif);base64,/.test(url),
...
// Caption request
export const CaptionRequestSchema = z
  .object({
...
// Mask request
export const MaskRequestSchema = z
  .object({
    imageUrl: imageUrlSchema,
  })
...
export const NextFrameRequestSchema = z
  .object({
