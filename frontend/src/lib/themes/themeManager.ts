...
export class ThemeManager {
  ...
  constructor() {
    ...
    this.currentThemeConfig = this.findTheme(this.state.currentTheme) || this.getDefaultTheme()
  ...
  createCustomTheme(config: Partial<ThemeConfig>): ThemeConfig {
    ...
    const theme: ThemeConfig = {
      ...
      accessibility: config.accessibility || this.currentThemeConfig.accessibility
    }
